...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="<?php echo base_url();?>assetsimg/favicon.ico">
	<!-- end: Favicon -->
...
<body>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2017 <a href="http://themifycloud.com/downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">SMK Telkom Malang</a></span>
