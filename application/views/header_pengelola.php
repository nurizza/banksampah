			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url();?>index.php/sampah_pengelola"><i class="icon-table"></i><span class="hidden-tablet">Data Sampah</span></a></li>
						<li><a href="<?php echo base_url();?>index.php/sampah_pengelola/tampilan_input_kelola"><i class="icon-pencil"></i><span class="hidden-tablet">Input Pengolaan</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
