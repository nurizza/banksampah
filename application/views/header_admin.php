				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo base_url();?>index.php/staff/data_staff"><i class="icon-table"></i><span class="hidden-tablet"> Data Staff </span></a></li>
								<li><a class="submenu" href="<?php echo base_url();?>index.php/staff"><i class="icon-pencil"></i><span class="hidden-tablet">Input Staff</span></a></li>
							</ul>	
						</li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-leaf"></i><span class="hidden-tablet"> Sampah</span>
								<b style="float: right;" class="fa fa-angle-down"></b></a>
							<ul>
								<li><a class="submenu" href="<?php echo base_url();?>index.php/sampah_admin/data_sampah"><i class="icon-table"></i><span class="hidden-tablet"> Data Sampah </span></a></li>
								<li><a class="submenu" href="<?php echo base_url();?>index.php/sampah_admin"><i class="icon-pencil"></i><span class="hidden-tablet">Input Pengumpulan</span></a></li>
								<li><a class="submenu" href="<?php echo base_url();?>index.php/sampah_admin/kelola_sampah"><i class="fa fa-hand-paper-o"></i><span class="hidden-tablet">Pengolaan Sampah</span></a></li>
							</ul>	
						</li>
